...
_MainFrame::_MainFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	this->Connect( wxID_NEW, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnNewProject ) );
	this->Connect( wxID_OPEN, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnOpenProject ) );
	this->Connect( wxID_SAVE, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnSaveProject ) );
	this->Connect( wxID_SAVEAS, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnSaveProjectAs ) );
	this->Connect( IDM_FILE_EXPORT, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnExportDiagram ) );
	this->Connect( IDM_FILE_EXPORT, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateCanvasActivated ) );
	this->Connect( wxID_PRINT, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateCanvasActivated ) );
	this->Connect( wxID_PREVIEW, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateCanvasActivated ) );
	this->Connect( wxID_PAGE_SETUP, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateCanvasActivated ) );
	this->Connect( wxID_EXIT, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnQuit ) );
	this->Connect( IDM_EDIT_SELECTALL, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnSelectAll ) );
	this->Connect( IDM_EDIT_SELECTALL, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateCanvasActivated ) );
	this->Connect( IDM_EDIT_PREFERENCES, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnPreferences ) );
	this->Connect( IDM_VIEW_RESET, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnResetLayout ) );
	this->Connect( IDM_VIEW_PROJECT_PANEL, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnToggleGUI ) );
	this->Connect( IDM_VIEW_PROJECT_PANEL, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateToggleGUI ) );
	this->Connect( IDM_VIEW_LOG_PANEL, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnToggleGUI ) );
	this->Connect( IDM_VIEW_LOG_PANEL, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateToggleGUI ) );
	this->Connect( IDM_VIEW_THUMBNAIL_PANEL, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnToggleGUI ) );
	this->Connect( IDM_VIEW_THUMBNAIL_PANEL, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateToggleGUI ) );
	this->Connect( IDM_VIEW_EDITOR, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnToggleGUI ) );
	this->Connect( IDM_VIEW_EDITOR, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateToggleGUI ) );
	this->Connect( IDM_VIEW_FILE_TB, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnToggleGUI ) );
	this->Connect( IDM_VIEW_FILE_TB, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateToggleGUI ) );
	this->Connect( IDM_VIEW_DIAGRAM_TB, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnToggleGUI ) );
	this->Connect( IDM_VIEW_DIAGRAM_TB, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateToggleGUI ) );
	this->Connect( IDM_VIEW_LAYOUT_TB, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnToggleGUI ) );
	this->Connect( IDM_VIEW_LAYOUT_TB, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateToggleGUI ) );
	this->Connect( IDM_VIEW_GENERATOR_TB, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnToggleGUI ) );
	this->Connect( IDM_VIEW_GENERATOR_TB, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateToggleGUI ) );
	this->Connect( IDM_PROJ_PACKAGE, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnCreateProjectItem ) );
	this->Connect( IDM_PROJ_PACKAGE, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateCreatePackage ) );
	this->Connect( IDM_PROJ_CODEPACKAGE, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnCreateProjectItem ) );
	this->Connect( IDM_PROJ_CODEPACKAGE, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateCreatePackage ) );
	this->Connect( IDM_PROJ_VARIABLE, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnCreateProjectItem ) );
	this->Connect( IDM_PROJ_VARIABLE, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateCreateCodeItem ) );
	this->Connect( IDM_PROJ_FUNCTION, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnCreateProjectItem ) );
	this->Connect( IDM_PROJ_FUNCTION, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateCreateCodeItem ) );
	this->Connect( IDM_PROJ_EDIT, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnEditItem ) );
	this->Connect( IDM_PROJ_EDIT, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateProjectItemSelected ) );
	this->Connect( IDM_PROJ_REMOVE, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnRemoveItem ) );
	this->Connect( IDM_PROJ_REMOVE, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateProjectItemSelected ) );
	this->Connect( IDM_PROJ_REMOVEALL, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnRemoveAll ) );
	this->Connect( IDM_PROJ_SETTINGS, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnSettings ) );
	this->Connect( IDM_BANK_MANAGE, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnManageBank ) );
	this->Connect( IDM_DIAG_STORETOBANK, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnStoreToBank ) );
	this->Connect( IDM_DIAG_STORETOBANK, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateStoreToBank ) );
	this->Connect( IDM_DIAG_INSERTFROMBANK, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnInsertFromBank ) );
	this->Connect( IDM_DIAG_INSERTFROMBANK, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateInsertFromBank ) );
	this->Connect( IDM_CODE_PREVIEW, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnPreviewClick ) );
	this->Connect( IDM_CODE_PREVIEW, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _MainFrame::OnUpdateGeneratorActivated ) );
	this->Connect( IDM_CODE_GENERATE, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnGenerateClick ) );
	this->Connect( IDM_CODE_SYNCHRONIZE, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnSynchronizeCode ) );
	this->Connect( IDM_PLUGINS_MANAGE, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnManagePlugins ) );
	this->Connect( wxID_ABOUT, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _MainFrame::OnAbout ) );
...
_EditorFrame::_EditorFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_scintillaEditor->SetMarginType( 1, wxSCI_MARGIN_SYMBOL );
	m_scintillaEditor->SetMarginMask( 1, wxSCI_MASK_FOLDERS );
	...
	m_scintillaEditor->SetFoldFlags( wxSCI_FOLDFLAG_LINEBEFORE_CONTRACTED | wxSCI_FOLDFLAG_LINEAFTER_CONTRACTED );
	m_scintillaEditor->SetMarginType( 0, wxSCI_MARGIN_NUMBER );
	m_scintillaEditor->SetMarginWidth( 0, m_scintillaEditor->TextWidth( wxSCI_STYLE_LINENUMBER, wxT("_99999") ) );
	m_scintillaEditor->StyleSetFont( wxSCI_STYLE_DEFAULT, wxFont( 10, 74, 90, 90, false, wxT("Courier New") ) );
	m_scintillaEditor->MarkerDefine( wxSCI_MARKNUM_FOLDER, wxSCI_MARK_BOXPLUS );
	m_scintillaEditor->MarkerSetBackground( wxSCI_MARKNUM_FOLDER, wxColour( wxT("BLACK") ) );
	m_scintillaEditor->MarkerSetForeground( wxSCI_MARKNUM_FOLDER, wxColour( wxT("WHITE") ) );
	m_scintillaEditor->MarkerDefine( wxSCI_MARKNUM_FOLDEROPEN, wxSCI_MARK_BOXMINUS );
	m_scintillaEditor->MarkerSetBackground( wxSCI_MARKNUM_FOLDEROPEN, wxColour( wxT("BLACK") ) );
	m_scintillaEditor->MarkerSetForeground( wxSCI_MARKNUM_FOLDEROPEN, wxColour( wxT("WHITE") ) );
	m_scintillaEditor->MarkerDefine( wxSCI_MARKNUM_FOLDERSUB, wxSCI_MARK_EMPTY );
	m_scintillaEditor->MarkerDefine( wxSCI_MARKNUM_FOLDEREND, wxSCI_MARK_BOXPLUS );
	m_scintillaEditor->MarkerSetBackground( wxSCI_MARKNUM_FOLDEREND, wxColour( wxT("BLACK") ) );
	m_scintillaEditor->MarkerSetForeground( wxSCI_MARKNUM_FOLDEREND, wxColour( wxT("WHITE") ) );
	m_scintillaEditor->MarkerDefine( wxSCI_MARKNUM_FOLDEROPENMID, wxSCI_MARK_BOXMINUS );
	m_scintillaEditor->MarkerSetBackground( wxSCI_MARKNUM_FOLDEROPENMID, wxColour( wxT("BLACK") ) );
	m_scintillaEditor->MarkerSetForeground( wxSCI_MARKNUM_FOLDEROPENMID, wxColour( wxT("WHITE") ) );
	m_scintillaEditor->MarkerDefine( wxSCI_MARKNUM_FOLDERMIDTAIL, wxSCI_MARK_EMPTY );
	m_scintillaEditor->MarkerDefine( wxSCI_MARKNUM_FOLDERTAIL, wxSCI_MARK_EMPTY );
	...
	m_scintillaEditor->SetFont( wxFont( 10, 74, 90, 90, false, wxT("Courier New") ) );
	...
	this->Connect( wxID_CLOSE, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _EditorFrame::OnCloseClick ) );
}
...
_InsertFromBankDialog::_InsertFromBankDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	this->Connect( IDM_DBANK_SELECTALL, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _InsertFromBankDialog::OnSelectAll ) );
	this->Connect( IDM_DBANK_DESELECTALL, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _InsertFromBankDialog::OnDeselectAll ) );
	this->Connect( IDM_DBANK_SHOWDEPS, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( _InsertFromBankDialog::OnShowDeps ) );
	this->Connect( IDM_DBANK_SHOWDEPS, wxEVT_UPDATE_UI, wxUpdateUIEventHandler( _InsertFromBankDialog::OnUpdateShowDeps ) );
...
_SynchronizeDialog::_SynchronizeDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_scintillaModified = new wxScintilla( this, wxID_ANY, wxDefaultPosition, wxSize( 300,200 ), 0, wxEmptyString );
	...
	m_scintillaModified->SetMarginType( 1, wxSCI_MARGIN_SYMBOL );
	m_scintillaModified->SetMarginMask( 1, wxSCI_MASK_FOLDERS );
	...
	m_scintillaModified->SetFoldFlags( wxSCI_FOLDFLAG_LINEBEFORE_CONTRACTED | wxSCI_FOLDFLAG_LINEAFTER_CONTRACTED );
	m_scintillaModified->SetMarginType( 0, wxSCI_MARGIN_NUMBER );
	m_scintillaModified->SetMarginWidth( 0, m_scintillaModified->TextWidth( wxSCI_STYLE_LINENUMBER, wxT("_99999") ) );
	m_scintillaModified->MarkerDefine( wxSCI_MARKNUM_FOLDER, wxSCI_MARK_BOXPLUS );
	m_scintillaModified->MarkerSetBackground( wxSCI_MARKNUM_FOLDER, wxColour( wxT("BLACK") ) );
	m_scintillaModified->MarkerSetForeground( wxSCI_MARKNUM_FOLDER, wxColour( wxT("WHITE") ) );
	m_scintillaModified->MarkerDefine( wxSCI_MARKNUM_FOLDEROPEN, wxSCI_MARK_BOXMINUS );
	m_scintillaModified->MarkerSetBackground( wxSCI_MARKNUM_FOLDEROPEN, wxColour( wxT("BLACK") ) );
	m_scintillaModified->MarkerSetForeground( wxSCI_MARKNUM_FOLDEROPEN, wxColour( wxT("WHITE") ) );
	m_scintillaModified->MarkerDefine( wxSCI_MARKNUM_FOLDERSUB, wxSCI_MARK_EMPTY );
	m_scintillaModified->MarkerDefine( wxSCI_MARKNUM_FOLDEREND, wxSCI_MARK_BOXPLUS );
	m_scintillaModified->MarkerSetBackground( wxSCI_MARKNUM_FOLDEREND, wxColour( wxT("BLACK") ) );
	m_scintillaModified->MarkerSetForeground( wxSCI_MARKNUM_FOLDEREND, wxColour( wxT("WHITE") ) );
	m_scintillaModified->MarkerDefine( wxSCI_MARKNUM_FOLDEROPENMID, wxSCI_MARK_BOXMINUS );
	m_scintillaModified->MarkerSetBackground( wxSCI_MARKNUM_FOLDEROPENMID, wxColour( wxT("BLACK") ) );
	m_scintillaModified->MarkerSetForeground( wxSCI_MARKNUM_FOLDEROPENMID, wxColour( wxT("WHITE") ) );
	m_scintillaModified->MarkerDefine( wxSCI_MARKNUM_FOLDERMIDTAIL, wxSCI_MARK_EMPTY );
	m_scintillaModified->MarkerDefine( wxSCI_MARKNUM_FOLDERTAIL, wxSCI_MARK_EMPTY );
	...
	m_scintillaModified->SetToolTip( wxT("Source code from generated files") );
	m_scintillaModified->SetMinSize( wxSize( 300,200 ) );
	
	compareSizer->Add( m_scintillaModified, 1, wxEXPAND|wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	
	m_scintillaOriginal = new wxScintilla( this, wxID_ANY, wxDefaultPosition, wxSize( 300,200 ), 0, wxEmptyString );
	...
	m_scintillaOriginal->SetMarginType( 1, wxSCI_MARGIN_SYMBOL );
	m_scintillaOriginal->SetMarginMask( 1, wxSCI_MASK_FOLDERS );
	...
	m_scintillaOriginal->SetFoldFlags( wxSCI_FOLDFLAG_LINEBEFORE_CONTRACTED | wxSCI_FOLDFLAG_LINEAFTER_CONTRACTED );
	m_scintillaOriginal->SetMarginType( 0, wxSCI_MARGIN_NUMBER );
	m_scintillaOriginal->SetMarginWidth( 0, m_scintillaOriginal->TextWidth( wxSCI_STYLE_LINENUMBER, wxT("_99999") ) );
	m_scintillaOriginal->MarkerDefine( wxSCI_MARKNUM_FOLDER, wxSCI_MARK_BOXPLUS );
	m_scintillaOriginal->MarkerSetBackground( wxSCI_MARKNUM_FOLDER, wxColour( wxT("BLACK") ) );
	m_scintillaOriginal->MarkerSetForeground( wxSCI_MARKNUM_FOLDER, wxColour( wxT("WHITE") ) );
	m_scintillaOriginal->MarkerDefine( wxSCI_MARKNUM_FOLDEROPEN, wxSCI_MARK_BOXMINUS );
	m_scintillaOriginal->MarkerSetBackground( wxSCI_MARKNUM_FOLDEROPEN, wxColour( wxT("BLACK") ) );
	m_scintillaOriginal->MarkerSetForeground( wxSCI_MARKNUM_FOLDEROPEN, wxColour( wxT("WHITE") ) );
	m_scintillaOriginal->MarkerDefine( wxSCI_MARKNUM_FOLDERSUB, wxSCI_MARK_EMPTY );
	m_scintillaOriginal->MarkerDefine( wxSCI_MARKNUM_FOLDEREND, wxSCI_MARK_BOXPLUS );
	m_scintillaOriginal->MarkerSetBackground( wxSCI_MARKNUM_FOLDEREND, wxColour( wxT("BLACK") ) );
	m_scintillaOriginal->MarkerSetForeground( wxSCI_MARKNUM_FOLDEREND, wxColour( wxT("WHITE") ) );
	m_scintillaOriginal->MarkerDefine( wxSCI_MARKNUM_FOLDEROPENMID, wxSCI_MARK_BOXMINUS );
	m_scintillaOriginal->MarkerSetBackground( wxSCI_MARKNUM_FOLDEROPENMID, wxColour( wxT("BLACK") ) );
	m_scintillaOriginal->MarkerSetForeground( wxSCI_MARKNUM_FOLDEROPENMID, wxColour( wxT("WHITE") ) );
	m_scintillaOriginal->MarkerDefine( wxSCI_MARKNUM_FOLDERMIDTAIL, wxSCI_MARK_EMPTY );
	m_scintillaOriginal->MarkerDefine( wxSCI_MARKNUM_FOLDERTAIL, wxSCI_MARK_EMPTY );
	...
	m_scintillaOriginal->SetToolTip( wxT("Source code from original code items") );
	m_scintillaOriginal->SetMinSize( wxSize( 300,200 ) );
