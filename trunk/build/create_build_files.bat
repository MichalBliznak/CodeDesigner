...
rem premake\premake-win32.exe --target cl-gcc --wx-version 28 --unicode --static-runtime --shared --no-builtin-propgrid
echo done...
echo.

rem ========== GNU Makefile ==========
premake\premake-win32.exe --target gnu --wx-version 28 --unicode --with-wx-shared --shared --no-builtin-propgrid
rem premake\premake-win32.exe --target gnu --wx-version 28 --unicode --static-runtime --shared --no-builtin-propgrid
echo done...
echo.
...
rem premake\premake-win32.exe --target cb-gcc --wx-version 28 --unicode --static-runtime --shared --no-builtin-propgrid
echo done...
echo.
...
rem premake\premake-win32.exe --target vs2005 --wx-version 28 --unicode --static-runtime --shared --no-builtin-wchar --no-builtin-propgrid
rem premake\premake-win32.exe --target vs2005 --wx-version 28 --unicode --static-runtime --shared --no-builtin-propgrid
echo done...
echo.
